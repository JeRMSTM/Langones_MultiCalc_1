package com.example.langones_multicalc_1.Model;
...
public class Model {
    ...
    public double getVolumedensity() {return volumedensity;}
    ...
    public void setVolumedensity(double volumedensity) {this.volumedensity = volumedensity;}
